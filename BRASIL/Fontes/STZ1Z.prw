...
ฑฑบPrograma  STZ1Z     บAutor  ณGiovani Zago    บ Data ณ  18/07/19    	  บฑฑ
...
User Function STZ1Z()
	...
	Local aArea2    := Z1Z->(GetArea())
	Local _cAlias1  := "Z1Z"
	Local _cFiltro  := " "
	Private cTitle  := "Veiculo x Colaborador"
	Private cChaveAux := ""
	Private _cGrp   := ' '
	Private _cCID   := "MODZ1Z"
	Private _cSSID  := "STZ1Z"
...
Static Function MenuDef(_cSSID)
	...
	If !Empty(_cProgram)
		...
		ADD OPTION aRotina TITLE "Visualizar"   ACTION "VIEWDEF.STZ1Z" OPERATION 2  ACCESS 0
		ADD OPTION aRotina TITLE "Incluir"      ACTION "VIEWDEF.STZ1Z" OPERATION 3  ACCESS 0
		ADD OPTION aRotina TITLE "Alterar"      ACTION "VIEWDEF.STZ1Z" OPERATION 4  ACCESS 0
		ADD OPTION aRotina TITLE "Excluir"      ACTION "VIEWDEF.STZ1Z" OPERATION 5  ACCESS 0 
	Endif
Return aRotina
...
Static Function ModelDef()
	...
	Local oStruCabec := FWFormStruct(1, "Z1Z")// Constru็ใo de estrutura de dados
	Local oModel
...
Static Function ViewDef()
	...
	Local oStruCabec := FWFormStruct(2, "Z1Z")
