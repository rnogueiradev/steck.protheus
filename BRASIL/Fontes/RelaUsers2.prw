...
TRCell():New(oSection,"BLOQUEADO","TRB","BLOQUEADO",,1)
...
oSection:Cell("BLOQUEADO"):SetBlock( { || aDados[8] } )
...
For nX :=1 to Len(aUsuario)
	...
	if Alltrim(aUsuario[nX][1][1])=="000796"
	//msgalert("")
	EndIf
	...
	aDados[8] := Iif(aUsuario[nX][1][17],"B","L")
