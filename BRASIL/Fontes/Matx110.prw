...
/*/
User Function Matx110( cAlias, nReg, nOpcx )
...
TRCell():New(oSection2,"C7_PRODUTO" ,"SC7",/*Titulo*/,/*Picture*/,TamSX3("B1_COD")[1]+4,/*lPixel*/,/*{|| code-block de impressao }*/,,,,,,.F.)
TRCell():New(oSection2,"DESCPROD"   ,"   ",STR0097   ,/*Picture*/,If(nTamCdProd<=15,23,33),/*lPixel*/, {|| cDescPro})
TRCell():New(oSection2,"C7_UM"      ,"SC7","UNID"   ,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection2,"C7_SEGUM"   ,"SC7","2 UM",/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
...
TRCell():New(oSection2,"PRECO"      ,"   ",STR0098,/*Picture*/,16/*Tamanho*/,/*lPixel*/,{|| nVlUnitSC7 })
TRCell():New(oSection2,"C7_IPI"     ,"SC7",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection2,"TOTAL"     ,"   ",STR0099,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nValTotSC7 })
TRCell():New(oSection2,"C7_DATPRF"  ,"SC7",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection2,"C7_CC"      ,"SC7",/*Titulo*/,PesqPict("SC7","C7_CC",20),IIf(cPaisLoc <> "BRA" ,32,10)/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
...
//				oReport:PrintText(STR0120,,051 ) //"NOTA: So aceitaremos a mercadoria se na sua Nota Fiscal constar o numero do nosso Pedido de Compras."
			Else
...
oReport:PrintText("Fornecedor: " + SA2->A2_NOME+" "+"Codigo: "+SA2->A2_COD+" "+"Loja :"+SA2->A2_LOJA,nLinPC,1025)
oReport:SkipLine()

nLinPC := oReport:Row()
oReport:PrintText(STR0088 + SM0->M0_ENDENT,nLinPC,15)
oReport:PrintText(STR0088 + SA2->A2_END+" "+"Bairro "+SA2->A2_BAIRRO,nLinPC,1025)
oReport:SkipLine()
...
oReport:PrintText("Cidade"+SA2->A2_MUN+" "+"Estado"+SA2->A2_EST+" "+"Cep" +SA2->A2_CEP+" "+"CNPJ "+Transform(SA2->A2_CGC,PesqPict("SA2","A2_CGC")),nLinPC,1025)
oReport:SkipLine()

nLinPC := oReport:Row()
oReport:PrintText(STR0092 + SM0->M0_TEL + Space(2) + STR0093 + SM0->M0_FAX ,nLinPC,15)
oReport:PrintText(STR0094 + "("+Substr(SA2->A2_DDD,1,3)+") "+Substr(SA2->A2_TEL,1,15) + " "+"Fax "+"("+Substr(SA2->A2_DDD,1,3)+") "+SubStr(SA2->A2_FAX,1,15)+" "+If( cPaisLoc$"ARG|POR|EUA",space(11) , STR0095 )+If( cPaisLoc$"ARG|POR|EUA",space(18), SA2->A2_INSCR ),nLinPC,1025)
oReport:SkipLine()
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function MATx110R3(cAlias,nReg,nOpcx)
...
If !lNewAlc
	...
	li++
	@ li,001 PSAY STR0120 //"NOTA: So aceitaremos a mercadoria se na sua Nota Fiscal constar o numero do nosso Pedido de Compras.!"
