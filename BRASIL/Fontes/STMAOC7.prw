...
User Function STMAOC7()
	...
	cQuery := " SELECT (C6_QTDVEN - C6_QTDENT) C6_SALDO,C6_PRCVEN,C6_VALOR,SC6030.* FROM UDBP12.SC6030 "
	cQuery += " WHERE C6_NUM IN('910019','909934','909975','909839','909733') "
...
//Teste de Inclusão
		...
		aadd(aCabec,{"C7_FORNECE" ,"005866"})
		aadd(aCabec,{"C7_LOJA" ,"01"})
		aadd(aCabec,{"C7_COND" ,"007"})
		aadd(aCabec,{"C7_CONTATO" ,"ROBSON"})
		...
		While(!EOF()) .AND. TSC6->C6_NUM == cNumC6
			...
			aadd(aLinha,{"C7_CONTA" ,"114001005" ,Nil})
			aadd(aLinha,{"C7_OBS" ,"Pedido Gerado pela rotina STMAOC7 ref. ao pedido de vendas "+Alltrim(cNumC6) ,Nil})
		...
		If !lMsErroAuto
			...
			_cQuery := " "
			_cQuery := " UPDATE UDBP12.SC5030 SET C5_ZNUMPC = '"+cDoc+"' "
