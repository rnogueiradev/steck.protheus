...
USER Function ACDV177X(nOpc)  
	...
	While .t.                    
		...
		ElseIf nProcesso ==6  //Embarque
			nProcesso += GetRealProc(U_ACDV175A(),nProcesso,aProc) // Everson Santana - 16.12.2021 - Alteração Migração
...
Static Function CBSelCB7(nModo,cChave)
	...
	If Empty(aOrdSep)
		VtAlert(,STR0017,.t.,4000,3)  //### "Ordem de separação não encontrada","Aviso"
