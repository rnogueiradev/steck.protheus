...
/*/
//--------------------------------------------------------------------
User Function RVG_GPE( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "RVG_GPE" )
				Else
					MsgStop( "Atualização não Realizada.", "RVG_GPE" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'PH1'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'PH1'+cEmpr																, ; //X2_ARQUIVO
	'USUARIOS EAA'															, ; //X2_NOME
	'USUARIOS EAA'															, ; //X2_NOMESPA
	'USUARIOS EAA'															, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Ano Referenc'															, ; //X3_TITULO
	'Ano Referenc'															, ; //X3_TITSPA
	'Ano Referenc'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pergunta 1'															, ; //X3_TITULO
	'Pergunta 1'															, ; //X3_TITSPA
	'Pergunta 1'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pergunta 2'															, ; //X3_TITULO
	'Pergunta 2'															, ; //X3_TITSPA
	'Pergunta 2'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pergunta 3'															, ; //X3_TITULO
	'Pergunta 3'															, ; //X3_TITSPA
	'Pergunta 3'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pergunta 4'															, ; //X3_TITULO
	'Pergunta 4'															, ; //X3_TITSPA
	'Pergunta 4'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pergunta 5'															, ; //X3_TITULO
	'Pergunta 5'															, ; //X3_TITSPA
	'Pergunta 5'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Resposta 1'															, ; //X3_TITULO
	'Resposta 1'															, ; //X3_TITSPA
	'Resposta 1'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Nao Alcancado;2=Parcialmente Alcancado;3=Alcancada;4=Excedida;5=Excedida Constantemente', ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Aval Superio'															, ; //X3_TITULO
	'Aval Superio'															, ; //X3_TITSPA
	'Aval Superio'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Comentarios'															, ; //X3_TITULO
	'Comentarios'															, ; //X3_TITSPA
	'Comentarios'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Coment aval'															, ; //X3_TITULO
	'Coment aval'															, ; //X3_TITSPA
	'Coment aval'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Auto Aval En'															, ; //X3_TITULO
	'Auto Aval En'															, ; //X3_TITSPA
	'Auto Aval En'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Enc. Gestor'															, ; //X3_TITULO
	'Enc. Gestor'															, ; //X3_TITSPA
	'Enc. Gestor'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSIX, { ;
	'PH1'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'PH1_FILIAL+PH1_USER+PH1_SUP'											, ; //CHAVE
	'Usuario+Superior'														, ; //DESCRICAO
	'Usuario+Superior'														, ; //DESCSPA
	'Usuario+Superior'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'PH1'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'PH1_FILIAL+PH1_SUP+PH1_USER'											, ; //CHAVE
	'Superior+Usuario'														, ; //DESCRICAO
	'Superior+Usuario'														, ; //DESCSPA
	'Superior+Usuario'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'PH2'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'PH2_FILIAL+PH2_USER+PH2_ANO'											, ; //CHAVE
	'Usuario+Ano Referenc'													, ; //DESCRICAO
	'Usuario+Ano Referenc'													, ; //DESCSPA
	'Usuario+Ano Referenc'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSX6, { ;
	...
	'ST_AMDEAA'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Usuarios que irao fazer a gestao do EAA'								, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX7, { ;
	'PH1_USER'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'USRFULLNAME( M->PH1_USER )'											, ; //X7_REGRA
	'PH1_NOME'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
For nI := 1 To Len( aSX7 )
	...
	If !SX7->( dbSeek( PadR( aSX7[nI][1], nTamSeek ) + aSX7[nI][2] ) )
		...
		If SX3->( dbSeek( SX7->X7_CAMPO ) )
			/* Removido\Ajustado - Não executa mais RecLock na SX3
			RecLock( "SX3", .F. )
			SX3->X3_TRIGGER := "S"
			MsUnLock()*/
		EndIf
