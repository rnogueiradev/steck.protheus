...
// Na versão P12 a rotina MNTA080 passou a ser em MVC
// Função BUTTONBAR utilizada para chamar o antigo PE MNTA0805 para alteração de filial do bem.
//--------------------------------------------------------------------------------------------------
...
//			cMsg := 'Antes da alteração de qualquer campo do formulário. ' + CRLF
