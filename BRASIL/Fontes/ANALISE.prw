...
±±ºDesc.     ³ Rotina analisar movimentacao e saldo em estoque.           º±±STFAR
...
*/
User Function ANALISE() //u_ANALISE()
Local oDlgMain
Local aArea          := GetArea()
...
@ 005,215 BUTTON  "Alterar SB2" SIZE 50,12 ACTION IIf( lVisu, Alert("Nao permitido"), fAjustSB2("SALDO_SB2") ) PIXEL OF oFolder:aDialogs[1]
...
@ 001,030 BUTTON "SB8 => SD5"      SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"), (cB8xD5 := "B8=>D5",Processa({||fDetaSB8()})) ) PIXEL OF oFolder:aDialogs[2]
@ 001,075 BUTTON "Incluir"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"), (fAjustSB8("B8_I")))                           PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
@ 001,120 BUTTON "Alterar"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSB8("B8_A")))                           PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
@ 001,165 BUTTON "Excluir"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSB8("B8_E")))                          PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
@ 001,320 BUTTON "Lote e Num.Lote"  SIZE 40,10 ACTION IIf( lVisu, Alert("Nao permitido"),(nOpSB8:= 1,Processa({||fDetaSB8()})))         PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=2,.T.,.F.)
@ 001,375 BUTTON "Lote"            SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(nOpSB8:= 2,Processa({||fDetaSB8()})))         PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
...
@ 121,030 BUTTON "SD5 => SB8"       SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(cB8xD5 := "D5=>B8",Processa({||fDetaSD5()}))) PIXEL OF oFolder:aDialogs[2]
@ 121,075 BUTTON "Incluir D5"       SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSD5("D5_I","02")))                      PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
@ 121,120 BUTTON "Alterar D5"       SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSD5("D5_A","02")))                      PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
@ 121,165 BUTTON "Excluir D5"       SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSD5("D5_E","02")))                      PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
@ 121,210 BUTTON "Incluir D5+B8"    SIZE 40,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSD5("D5+B8_I","02")))                   PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
@ 121,265 BUTTON "Subtrair D5+B8"   SIZE 40,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSD5("D5+B8_S","02")))                   PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
@ 121,320 BUTTON "Estornar D5+B8"   SIZE 40,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSD5("D5+B8_E","02")))                   PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=1,.T.,.F.)
...
@ 001,030 BUTTON "SBF => SDB"      SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(cBFxDB := "BF=>DB",Processa({||fDetaSBF()}))) PIXEL OF oFolder:aDialogs[3]
@ 001,075 BUTTON "Incluir"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBF("BF_I")))                           PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
@ 001,120 BUTTON "Alterar"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBF("BF_A")))                           PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
@ 001,165 BUTTON "Excluir"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBF("BF_E")))                           PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
...
@ 121,030 BUTTON "SDB => SBF"       SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(cBFxDB := "DB=>BF",Processa({||fDetaSDB()}))) PIXEL OF oFolder:aDialogs[3]
@ 121,075 BUTTON "Incluir DB"       SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSDB("DB_I","03")))                      PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
@ 121,120 BUTTON "Alterar DB"       SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSDB("DB_A","03")))                      PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
@ 121,165 BUTTON "Excluir DB"       SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSDB("DB_E","03")))                      PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
@ 121,210 BUTTON "Incluir DB+BF"    SIZE 40,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSDB("DB+BF_I","03")))                   PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
@ 121,265 BUTTON "Subtrair DB+BF"   SIZE 40,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSDB("DB+BF_S","03")))                   PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
@ 121,320 BUTTON "Estornar DB+BF"   SIZE 40,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSDB("DB+BF_E","03")))                   PIXEL OF oFolder:aDialogs[3] When IF(nOpSBF=1,.T.,.F.)
...
@ 001,210 BUTTON "Incluir"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBJ("BJ_I")))        PIXEL OF oFolder:aDialogs[6]
@ 001,265 BUTTON "Alterar"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBJ("BJ_A")))        PIXEL OF oFolder:aDialogs[6]//IIf( lVisu, Alert("Nao permitido"),(fAjustSBJ("BJ_A")))        PIXEL OF oFolder:aDialogs[6]
@ 001,320 BUTTON "Excluir"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBJ("BJ_E")))        PIXEL OF oFolder:aDialogs[6]
...
@ 001,210 BUTTON "Incluir"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBK("BK_I")))        PIXEL OF oFolder:aDialogs[7]
@ 001,265 BUTTON "Alterar"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBK("BK_A")))        PIXEL OF oFolder:aDialogs[7]//IIf( lVisu, Alert("Nao permitido"),(fAjustSBK("BK_A")))       PIXEL OF oFolder:aDialogs[7]
@ 001,320 BUTTON "Excluir"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSBK("BK_E")))        PIXEL OF oFolder:aDialogs[7]
...
@ 001,220 BUTTON "Alterar no SB2"                  SIZE 45,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSB2("CLASS_SB2")))     PIXEL OF oFolder:aDialogs[8]
@ 001,320 BUTTON "Alterar no SDA"                  SIZE 45,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSDA("SDA")))           PIXEL OF oFolder:aDialogs[8]
...
@ 121,420 BUTTON "Alterar"     SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustDAB8("DAxB8")))  PIXEL OF oFolder:aDialogs[8]
...
@ 001,180 BUTTON "Incluir SD5"     SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSD5("D5_I","13")))                         PIXEL OF oFolder:aDialogs[12]
@ 001,240 BUTTON "Incluir SDB"     SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustSDB("DB_I","13")))                         PIXEL OF oFolder:aDialogs[12]
@ 001,300 BUTTON "Alterar"         SIZE 30,10 ACTION IIf( lVisu, Alert("Nao permitido"),(fAjustD5DB("D5DB_A")))                           PIXEL OF oFolder:aDialogs[12]
...
Static Function fOK()
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//lVisu	:= iif(ALLTRIM(cSenhAce)==ALLTRIM(cSenha),.T.,.F.)
