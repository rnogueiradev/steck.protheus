...
User Function STGPE016(xEmp,xFil,xMin,xMax)

Local cTexto	:=	""

Local cQuery	:=	"Select * From SRACRM "
Local lPriVez	:=	.t.
...
if	lIsBlind	
	...
	cArquivo	:= 	SuperGetMv("ST_EXPSA16",.f.,"\system\temp\stgpe016.csv")
