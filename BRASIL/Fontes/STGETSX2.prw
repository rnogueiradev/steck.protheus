...
|=====================================================================================|
|Descrição | Tela para consultar tabelas							                  |
|          |                                                                          |
|          |                                                                          |
|=====================================================================================|
|Sintaxe   | 		                                                                  |
...
User Function STGETSX2()
	...
	DEFINE MSDIALOG oWindow TITLE "Consulta de tabelas" FROM 000,000 TO aSize[6]/2,aSize[5]/2 TITLE Alltrim(OemToAnsi('Listagem de usuários')) Pixel //430,531
