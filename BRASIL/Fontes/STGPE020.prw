...
User Function STGPE020(xEmp,xFil,xMin,xMax)

Local cTexto	:=	""

Local cQuery	:=	"Select * From SRACRM5"
Local lPriVez	:=	.t.
...
if	lIsBlind	
    ...
    Conout("<<STGPE020>> Inicio de processamento")
    cArquivo	:= 	SuperGetMv("ST_EXPSA20",.f.,"\system\temp\stgpe020.csv") 
...
if	lIsBlind
	Reset Environment  
    Conout("<<STGPE020>> Fim de processamento")
endif
