...
ฑฑบ Programa ณ GFE11I16 บ Autor ณ TOTVS Protheus     บ Data ณ  26/08/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ GFE11I16   - Gerado por EXPORDIC / Upd. V.4.10.7 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function XGFE11I16( cEmpAmb, cFilAmb )
	...
	If lOk
		...
		If !Empty( aMarcadas )
			If lAuto .OR. MsgNoYes( "Confirma a atualiza็ใo dos dicionแrios ?", cTitulo )
				...
				If lAuto
					If lOk
						MsgStop( "Atualiza็ใo Realizada.", "GFE11I16" )
						dbCloseAll()
					Else
						MsgStop( "Atualiza็ใo nใo Realizada.", "GFE11I16" )
						dbCloseAll()
					EndIf
				Else
					If lOk
...
// Tabela GV4
//
	aAdd( aSX3, {'GV4','06','GV4_LBRMAT','C',1,0,'Lib Rom Aut','Lib Rom Aut','Lib Rom Aut','Libera Romaneio Automatic','Libera Romaneio Automatic','Libera Romaneio Automatic','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'"0"','',0,	Chr(254) + Chr(192),'','','','N','A','R','','','0=Data informada;1=Data emissao Doc. Carga','','','','','','','',''} )
//
// Tabela GV5
//
	aAdd( aSX3, {'GV5','09','GV5_CALC','C',1,0,'Calculo fret','Calculo fret','Calculo fret','Calculo Frete','Calculo Frete','Calculo Frete','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'"1"','',0,	Chr(254) + Chr(192),'','','','N','A','R','','','1=Manual;2=Automatico','','','','','','','',''} )
	aAdd( aSX3, {'GV5','10','GV5_EMITPF','C',1,0,'Emite PreFat','Emite PreFat','Emite PreFat','Emite Pre-Fatura','Emite Pre-Fatura','Emite Pre-Fatura','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'"1"','',0,	Chr(254) + Chr(192),'','','','N','A','R','','','1=Sim;2=Nao','','','','','','','',''} )
	aAdd( aSX3, {'GV5','11','GV5_DTENAT','C',1,0,'Data Ent Aut','Data Ent Aut','Data Ent Aut','Data Entrada Automatica','Data Entrada Automatica','Data Entrada Automatica','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'"0"','',0,	Chr(254) + Chr(192),'','','','N','A','R','','','0=Data informada;1=Data criacao Doc. Carga','','','','','','','',''} )
//
// Tabela GW1
//
	aAdd( aSX3, {'GW1','52','GW1_CALCAT','C',1,0,'Sit Calc Aut','Sit Calc Aut','Sit Calc Aut','Sit. do Calculo Automatic','Sit. do Calculo Automatic','Sit. do Calculo Automatic','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'"1"','',0,	Chr(254) + Chr(192),'','','','N','V','R','','','0=Nao se aplica;1=Calculo aut. pendente;2=Calculo automatico;3=Calculo sem sucesso;4=Romaneio sem sucesso','','','','','','','2',''} )
//
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  26/08/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
// Tabela GW1
//
	aAdd( aSIX, {'GW1','E','GW1_FILIAL+GW1_CARREG','Carregamento','Carregamento','Carregamento','S','','',''} )
//
// Atualizando dicionแrio
//
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX6 บ Autor ณ TOTVS Protheus     บ Data ณ  26/08/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function FSAtuSX6( cTexto )
	...
	aAdd( aSX6, {'  ','MV_ESCTBAT','C','Informa o criterio de desempate no calculo automat','','','tico do romaneio. 1=Menor Valor Frete;2=Menor Praz','','','o','','','','','','S',''} )
//
// Atualizando dicionแrio
//
...
//
	aHlpPor := {}
	aAdd( aHlpPor, 'Determina se o romaneio deve ser' )
	aAdd( aHlpPor, 'liberado' )
	aAdd( aHlpPor, 'sempre que houver um novo vํnculo a um' )
	aAdd( aHlpPor, 'documento de carga, encerrado-o se os' )
	aAdd( aHlpPor, 'documentos estiverem entregues.' )
	aHlpEng := {}
	aHlpSpa := {}

	PutHelp( "PGV4_LBRMAT", aHlpPor, aHlpEng, aHlpSpa, .T. )
	cTexto += "Atualizado o Help do campo " + "GV4_LBRMAT" + CRLF

//
// Helps Tabela GV5
//
	aHlpPor := {}
	aAdd( aHlpPor, 'Determina se na cria็ใo ou altera็ใo de' )
	aAdd( aHlpPor, 'documentos de carga, deverแ ser efetuado' )
	aAdd( aHlpPor, 'o cแlculo de frete para documentos' )
	aAdd( aHlpPor, 'liberados.' )
	aHlpEng := {}
	aHlpSpa := {}

	PutHelp( "PGV5_CALC  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
	cTexto += "Atualizado o Help do campo " + "GV5_CALC" + CRLF

	aHlpPor := {}
	aAdd( aHlpPor, 'Determina se o Romaneio estarแ liberado' )
	aAdd( aHlpPor, 'para emissใo de Pr้-Fatura' )
	aHlpEng := {}
	aHlpSpa := {}

	PutHelp( "PGV5_EMITPF", aHlpPor, aHlpEng, aHlpSpa, .T. )
	cTexto += "Atualizado o Help do campo " + "GV5_EMITPF" + CRLF

	aHlpPor := {}
	aAdd( aHlpPor, 'Determina se em novos documentos de' )
	aAdd( aHlpPor, 'carga' )
	aAdd( aHlpPor, 'ou documentos via integra็ใo o sistema' )
	aAdd( aHlpPor, 'deverแ realizar a entrega automแtica,' )
	aAdd( aHlpPor, 'preenchendo a data de entrega.' )
	aHlpEng := {}
	aHlpSpa := {}

	PutHelp( "PGV5_DTENAT", aHlpPor, aHlpEng, aHlpSpa, .T. )
	cTexto += "Atualizado o Help do campo " + "GV5_DTENAT" + CRLF

//
// Helps Tabela GW1
//
	aHlpPor := {}
	aAdd( aHlpPor, 'Apresenta a Situa็ใo do Cแlculo' )
	aAdd( aHlpPor, 'Automแtico' )
	aHlpEng := {}
	aHlpSpa := {}

	PutHelp( "PGW1_CALCAT", aHlpPor, aHlpEng, aHlpSpa, .T. )
	cTexto += "Atualizado o Help do campo " + "GW1_CALCAT" + CRLF
...
Static Function MyOpenSM0(lShared)
	...
	For nLoop := 1 To 20
		dbUseArea( .T.,"TOPCONN", "SIGAMAT.EMP", "SM0", lShared, .F. ) //Alterado 18/05/23 - adicionado o driver "TOPCONN"
