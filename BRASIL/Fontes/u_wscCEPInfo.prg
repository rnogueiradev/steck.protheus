...
cSoap += '<CEPSEARCH xmlns="http://10.152.4.7/ws/u_wscepinfo.apw">'
cSoap += WSSoapValue("CEP", ::cCEP, cCEP , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</CEPSEARCH>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://10.152.4.7/ws/u_wscepinfo.apw/CEPSEARCH",; 
	"DOCUMENT","http://10.152.4.7/ws/u_wscepinfo.apw",,"1.031217",; 
	"http://10.152.4.7/ws/U_WSCEPINFO.apw")
