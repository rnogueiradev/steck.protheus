		...
		Do While SM0->(!eof())
			If !Deleted()
				If aScan(aEmpresa, SM0->M0_CODIGO) == 0 //.and. SM0->M0_CODIGO $ "05/06"
					If SM0->M0_CODIGO=="01" .Or. SM0->M0_CODIGO=="03" .Or. SM0->M0_CODIGO=="11" 
...
Static Function rel011b()
	...
	If Select("SM0") == 0
		dbUseArea(.T.,"TOPCONN", 'SIGAMAT.EMP', 'SM0', .T., .F.) //Alterado - 11/05/23 - dbUseArea(.T.,, 'SIGAMAT.EMP', 'SM0', .T., .F.)
	EndIf
...
Static Function FSAtuSX2()
	...
	*/
	...
	if File('sx2_virada.dtc')
		...
		DbUseArea( .T.,"TOPCONN", 'sx2_virada.dtc', 'VIRASX2', .F., .F. ) //Alterado - 11/05/23 - dbUseArea(.T.,, 'sx2_virada.dtc', 'VIRASX2', .F., .F. )
...
Static Function FSAtuSX3()
	...
	if File('sx3_virada.dtc')
		...
		DbUseArea( .T.,"TOPCONN", 'sx3_virada.dtc', 'VIRASX3', .F., .F. )  //Alterado - 11/05/23 - dbUseArea(.T.,, 'sx3_virada.dtc', 'VIRASX3', .F., .F. )
...
Static Function FSAtuSIX()
	...
	if File('six_virada.dtc')
		...
		DbUseArea( .T.,"TOPCONN", 'six_virada.dtc', 'VIRASIX', .F., .F. ) //Alterado - 11/05/23 - dbUseArea(.T.,,'six_virada.dtc', 'VIRASIX', .F., .F. )
...
Static Function FSAtuSX6()
	...
	if File('sx6_virada.dtc')
		...
		DbUseArea( .T.,"topconn", 'sx6_virada.dtc', 'VIRASX6', .F., .F. ) //Alterado - 11/05/23 - dbUseArea(.T.,, 'sx6_virada.dtc', 'VIRASX6', .F., .F. )
...
Static Function FSAtuSX7()
	...
	if File('sx7_virada.dtc')
		...
		DbUseArea( .T.,"topconn", 'sx7_virada.dtc', 'VIRASX7', .F., .F. ) //Alterado - 11/05/23 - DbUseArea( .T., , 'sx7_virada.dtc', 'VIRASX7', .F., .F. )
		...
		For nI := 1 To Len( aSX7 )
			...
			dbCommit()
			MsUnLock()
/*Removido - 12/05/23 - Toda e qualquer manipulação de dados deve ser feita apenas pelo módulo Configurador ou pela rotina de atualização de versão
...
Static Function FSAtuSXA()
	...
	if File('sxa_virada.dtc')
		...
		DbUseArea( .T.,"TOPCONN", 'sxa_virada.dtc', 'VIRASXA', .F., .F. ) //Alterado - 12/05/23 - DbUseArea( .T., , 'sxa_virada.dtc', 'VIRASXA', .F., .F. )
...
Static Function FSAtuSXB()
	...
	if File('sxb_virada.dtc')
		...
		DbUseArea( .T.,"TOPCONN", 'sxb_virada.dtc', 'VIRASXB', .F., .F. ) //Alterado - 12/05/23 - DbUseArea( .T., , 'sxb_virada.dtc', 'VIRASXB', .F., .F. )
...
Static Function FSAtuSX5()
	...
	if File('sx5_virada.dtc')
		...
		DbUseArea( .T.,"TOPCONN", 'sx5_virada.dtc', 'VIRASX5', .F., .F. ) //Alterado - 12/05/23 - DbUseArea( .T., , 'sx5_virada.dtc', 'VIRASX5', .F., .F. )
