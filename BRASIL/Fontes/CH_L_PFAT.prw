...
cQuery += "         SUBSTR(SF2.F2_EMISSAO,1,4) ||'-'|| SUBSTR(SF2.F2_EMISSAO,5,2)||'-'||SUBSTR(SF2.F2_EMISSAO,7,2)||'T23:59:59.000-03:00' DOCUMENTO_DATAEMISSAO,"
cQuery += "         'http://144.22.152.165:5020/wsconectahub/pedido/xml?chavexml='||RTRIM(SF2.F2_CHVNFE) DOCUMENTO_URLXML,"
