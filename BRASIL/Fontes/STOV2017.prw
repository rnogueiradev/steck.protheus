...
\====================================================================================*/
*-----------------------------*
User Function STOV2017()   //  u_STOV2017() 
	*-----------------------------*
	//-- Dimensoes padroes
	...
	*/
	...
	_nlin := 35
	@ _nlin,005 	Say "1. Por favor, indique até que ponto você concorda com cada uma das seguintes declarações " PIXEL of oDlg  FONT oFontB COLOR CLR_RED
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Meu superior imediato fornece feedback que ajuda a melhorar o meu desempenho." PIXEL of oDlg  FONT oFontN		//"Meu gerente fornece feedback que me ajuda a melhorar meu desempenho."
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "As ferramentas e os recursos fornecidos permitem que eu seja o mais produtivo possível." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Eu acho que a colaboração entre as equipes e as entidades está indo bem." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Minha organização cuida ativamente do bem-estar de seus funcionários." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Eu não hesitaria em recomendar a Steck para um amigo a procura de emprego." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Quando tenho oportunidade, conto aos outros coisas boas sobre como é trabalhar aqui." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Eu raramente penso em deixar a Steck para trabalhar em outro lugar." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Seria preciso muito para me convencer a deixar a Steck." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "A Steck me motiva a contribuir mais do que normalmente é necessário para concluir o meu trabalho." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "A Steck me inspira a fazer o meu melhor trabalho todos os dias." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Na Steck, estamos sempre em busca de melhores formas de atender aos nossos clientes." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Recebo reconhecimento adequado (além do meu salário e benefícios) pelas minhas contribuições e realizações." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,005 	Say "Você está ciente que planos de ação são definidos em sua organização após a aplicação da pesquisa OneVoice?" PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	@ _nlin,005  ComboBox oStat15 VAR cStat15 ITEMS {' ','S-Sim','N-Não'} Of oDlg PIXEL SIZE 85,10
	_nlin+= _nlin12

	@ _nlin,005 	Say "Os planos de ação da pesquisa OneVoice tiveram um impacto positivo em meu engajamento?" PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
