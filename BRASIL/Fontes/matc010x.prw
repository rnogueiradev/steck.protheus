				...
				If MsSeek(xFilial("SH1")+SG2->G2_RECURSO)
					...
					If SG2->G2_TPOPER $ " 1"
						...
						if (cEmpAnt=="03") .and. (!EMPTY(SG2->G2_TPALOCF)) .and. SG2->G2_OPERAC=='10'
						   nTmpMAO := SG2->( (G2_TEMPAD / G2_LOTEPAD) )
						endif					
					...
					// Valdemir Rabelo 13/05/2020
					if (cEmpAnt=="03") .and. ("120108" $ cProdMod)
						nTemp := nTmpMAO
					endif 
					...
					If SB1->(MsSeek(xFilial("SB1")+cProdMod))
						...
						If IsInCallStack("MATR430") .Or. IsInCallStack("MATC010")
							If IsInCallStack("MATR430")
								_cStd := UPPER(aPar[12])
							Else
								_cStd := "N"
							EndIf
...
�����������������������������������������������������������������������������
*/
Static Function QualCusto(cProduto,_nRecno,_nLin)
...
Static Function CalcTot(nMatPrima,nUltNivel,aFormulas,nQc,nOpcx)
	...
	For nX := nMatPrima-2 To 1 Step -1
		If cNivEstr == aArray[nX][2]
			If nQc != 8
				nCusto := QualCusto(aArray[nX][4],aArray[nX][16],nX)
		...
		Else
			...
			Else
				...
				Next nY
				If nQc != 8
					nCusto := QualCusto(aArray[nX][4],0,nX)
					aArray[nX][6] := aArray[nX][5] * nCusto
				EndIf
				//��������������������������������������������������������������Ŀ
				//� Este vetor (aAuxCusto) deve ser declarado somente no MATR430 �
...
�����������������������������������������������������������������������������
*/
Static Function Substitui(cFormula)
...
�����������������������������������������������������������������������������
*/
Static Function AcertaForm(cFormula,nQtd,n)
...
�����������������������������������������������������������������������������
*/
Static Function CondTot(cFormula)
...
�����������������������������������������������������������������������������
*/
Static Function MC010Forma(cAlias,nReg,nOpcx,nQtdBas,nTipo,lMostra,cRevExt,_lCustoStd)
...
�����������������������������������������������������������������������������
*/
Static Function MC010Grava(cArq, cArqAnt, nMatPrima, aFormulas)
...
�����������������������������������������������������������������������������
*/
Static Function MC010Rev(cArq, cArqAnt, nMatPrima, aFormulas)
...
�����������������������������������������������������������������������������
*/
Static Function C010SetVLine( nLine, nValue )
	Local nPos := 0
