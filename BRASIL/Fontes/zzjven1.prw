...
/*/
//--------------------------------------------------------------------
User Function ZZJVEN1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "ZZJVEN1" )
				Else
					MsgStop( "Atualização não Realizada.", "ZZJVEN1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'PREVISAO DE ENTREGA'													, ; //X2_NOME
	'PREVISAO DE ENTREGA'													, ; //X2_NOMESPA
	'PREVISAO DE ENTREGA'													, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
For nI := 1 To Len( aSX2 )
	...
	Else
		...
		If  !( StrTran( Upper( AllTrim( SX2->X2_UNICO ) ), " ", "" ) == StrTran( Upper( AllTrim( aSX2[nI][12]  ) ), " ", "" ) )
			/*Removido\Ajustado - Não executa mais RecLock no SX2
			RecLock( "SX2", .F. )
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Data Previst'															, ; //X3_TITULO
	'Data Previst'															, ; //X3_TITSPA
	'Data Previst'															, ; //X3_TITENG
	'Data Previst'															, ; //X3_DESCRIC
	'Data Previst'															, ; //X3_DESCSPA
	'Data Previst'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Transporte'															, ; //X3_TITULO
	'Transporte'															, ; //X3_TITSPA
	'Transporte'															, ; //X3_TITENG
	'Transporte'															, ; //X3_DESCRIC
	'Transporte'															, ; //X3_DESCSPA
	'Transporte'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'DT.REPROCES'															, ; //X3_TITULO
	'DT.REPROCES'															, ; //X3_TITSPA
	'DT.REPROCES'															, ; //X3_TITENG
	'DT.REPROCES'															, ; //X3_DESCRIC
	'DT.REPROCES'															, ; //X3_DESCSPA
	'DT.REPROCES'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'HORA REPROC'															, ; //X3_TITULO
	'HORA REPROC'															, ; //X3_TITSPA
	'HORA REPROC'															, ; //X3_TITENG
	'HORA REPROC'															, ; //X3_DESCRIC
	'HORA REPROC'															, ; //X3_DESCSPA
	'HORA REPROC'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'USER REPROCS'															, ; //X3_TITULO
	'USER REPROCS'															, ; //X3_TITSPA
	'USER REPROCS'															, ; //X3_TITENG
	'USER REPROCS'															, ; //X3_DESCRIC
	'USER REPROCS'															, ; //X3_DESCSPA
	'USER REPROCS'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	50																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Mot.Cancelam'															, ; //X3_TITULO
	'Mot.Cancelam'															, ; //X3_TITSPA
	'Mot.Cancelam'															, ; //X3_TITENG
	'Mot.Cancelam'															, ; //X3_DESCRIC
	'Mot.Cancelam'															, ; //X3_DESCSPA
	'Mot.Cancelam'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Alteração'																, ; //X3_TITSPA
	'Alteração'																, ; //X3_TITENG
	'Alteração'																, ; //X3_DESCRIC
	'Alteração'																, ; //X3_DESCSPA
	'Alteração'																, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZZJ'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZZJ_FILIAL+ZZJ_COD+ZZJ_DATA'											, ; //CHAVE
	'Produto+Data Previst'													, ; //DESCRICAO
	'Produto+Data Previst'													, ; //DESCSPA
	'Produto+Data Previst'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'ZZJ'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZZJ_FILIAL+ZZJ_DATA+ZZJ_COD'											, ; //CHAVE
	'Data Previst+Produto'													, ; //DESCRICAO
	'Data Previst+Produto'													, ; //DESCSPA
	'Data Previst+Produto'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
cTexto  += "Ínicio da Atualização SX5" + CRLF + CRLF
...
aAdd( aSX5, { ;
	...
	'00'																	, ; //X5_TABELA
	'Z4'																	, ; //X5_CHAVE
	'MOTIVO DE CANCELAMENTO COMPROMISSO DE ENTREGA'							, ; //X5_DESCRI
	'MOTIVO DE CANCELAMENTO COMPROMISSO DE ENTREGA'							, ; //X5_DESCSPA
	'MOTIVO DE CANCELAMENTO COMPROMISSO DE ENTREGA'							} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'Z4'																	, ; //X5_TABELA
	'01'																	, ; //X5_CHAVE
	'ERRO DE DATA DE COMPROMISSO'											, ; //X5_DESCRI
	'ERRO DE DATA DE COMPROMISSO'											, ; //X5_DESCSPA
	'ERRO DE DATA DE COMPROMISSO'											} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'Z4'																	, ; //X5_TABELA
	'02'																	, ; //X5_CHAVE
	'PROBLEMA INJETORA'														, ; //X5_DESCRI
	'PROBLEMA INJETORA'														, ; //X5_DESCSPA
	'PROBLEMA INJETORA'														} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'Z4'																	, ; //X5_TABELA
	'03'																	, ; //X5_CHAVE
	'PROBLEMA EMPILHADEIRA'													, ; //X5_DESCRI
	'PROBLEMA EMPILHADEIRA'													, ; //X5_DESCSPA
	'PROBLEMA EMPILHADEIRA'													} ) //X5_DESCENG
...
cTexto += CRLF + "Final da Atualização" + " SX5" + CRLF + Replicate( "-", 128 ) + CRLF + CRLF
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Tabela z4' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZJ_CANCEL", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZZJ_CANCEL" + CRLF
