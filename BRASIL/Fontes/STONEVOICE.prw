...
|=====================================================================================|
|Descrição |   STONEVOICE  Pesquisa ONE VOICE	                                      |
|          |                                                                          |
|          |                                                                          |
|=====================================================================================|
|Sintaxe   | STONEVOICE                                                               |
...
\====================================================================================*/
*-----------------------------*
User Function STONEVOICE()   //  u_STONEVOICE()
*-----------------------------*
//-- Dimensoes padroes
	...
	//MsgAlert("Pesquisa do ano passado, não está mais disponível!")
	//Return
 
	//If !(__CUSERID $ GetMv("ST_ONEVOI",,'000000')+'000000/000210')
	...
	DEFINE MSDIALOG oDlg TITLE cCadastro FROM 0,0 TO aSize[6]+220,aSize[5]-30   of GetWndDefault() Pixel
...
//  u_STONEVOICE()
	...
	@  173,005 	Say "6. Caso você não indique a Steck aos  " PIXEL of oDlg  FONT oFontB COLOR CLR_RED
	@  180,005 	Say "seus amigoscomo um bom lugar para se  "  PIXEL of oDlg  FONT oFontB COLOR CLR_RED
	@  187,005 	Say "trabalhar, por favor,nos informe quais  " PIXEL of oDlg  FONT oFontB COLOR CLR_RED
...
//oChk25:blClicked  		:= {|| RefreOne(25) }
	...
	@ 305,005 	Say "Outros(Especifique) " PIXEL of oDlg  FONT oFontn
	@ 315 , 005 MSGET oDesc 	Var cDesc 	SIZE 090, 09 OF oDlg PIXEL
	...
	_nlin+= _nlin7
	@ _nlin,170 	Say "   sobre o seu trabalho na Steck." PIXEL of oDlg  FONT oFontB COLOR CLR_RED
	_nlin+= _nlin7
	_nlin+= _nlin12
	@ _nlin,170 	Say "A Steck me motiva a contribuir mais do que é normalmente pedido para completar o meu trabalho." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Eu encontro o equilíbrio adequado entre os meus compromissos no trabalho e na vida pessoal." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "A Steck me inspira a dar o melhor de mim todos os dias." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Sei qual é a relação entre meus objetivos de trabalho e os objetivos da Steck." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Disponho de oportunidades me permitindo evoluir pessoal e profissionalmente." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Eu dificilmente penso em deixar a Steck para trabalhar em outro lugar." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Eu somente sairei da Steck por algo muito melhor." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Quando surge a oportunidade, eu conto a outras pessoas coisas boas sobre trabalhar na Steck." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Meus colegas de trabalho respeitam minhas ideias e meus sentimentos." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Meu superior me dá o feedback necessário para me ajudar a melhorar minha performance." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Penso que a cooperação entre departamentos é boa." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
	...
	@ _nlin,170 	Say "Eu não hesitaria em recomendar a Steck a um amigo que estivesse procurando emprego." PIXEL of oDlg  FONT oFontN
	_nlin+= _nlin7
...
// se a opcao for encerrar executa a rotina.
	If nOpca == 1
		...
		Else
			...
			Dbselectarea("PPC")
			PPC->(DbSetorder(2))
			If  PPC->(DbSeek(xFilial('PPC')+__CUSERID))
				MsgInfo("Obrigado Pela Sua Participação....!!!!!")
			Else
				Processa( {|| STGRVMIX() }, "Aguarde...", "Gravando Pesquisa...",.F.)
				MsgInfo("Obrigado Pela Sua Participação....!!!!!")
