...
/*/
//--------------------------------------------------------------------
User Function STK_INV( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "STK_INV" )
				Else
					MsgStop( "Atualização não Realizada.", "STK_INV" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'PPF'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'PPF'+cEmpr																, ; //X2_ARQUIVO
	'USUARIOS INVENTARIO STECK'												, ; //X2_NOME
	'USUARIOS INVENTARIO STECK'												, ; //X2_NOMESPA
	'USUARIOS INVENTARIO STECK'												, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'USRFULLNAME(M->PPF_USUARI)'											, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'USRFULLNAME(PPF->PPF_USUARI)'											, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_CONDSQL
	''																		, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'1 Contagem'															, ; //X3_TITULO
	'1 Contagem'															, ; //X3_TITSPA
	'1 Contagem'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'2 Contagem'															, ; //X3_TITULO
	'2 Contagem'															, ; //X3_TITSPA
	'2 Contagem'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'3 Contagem'															, ; //X3_TITULO
	'3 Contagem'															, ; //X3_TITSPA
	'3 Contagem'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Endereco de'															, ; //X3_TITULO
	'Endereco de'															, ; //X3_TITSPA
	'Endereco de'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Endereco Ate'															, ; //X3_TITULO
	'Endereco Ate'															, ; //X3_TITSPA
	'Endereco Ate'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
