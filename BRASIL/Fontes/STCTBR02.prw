...
±±ºPrograma  ³STCTBR02	ºAutor  ³Renato Nogueira     º Data ³  25/11/13   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Relatório de produtos por nota - reduzido	    	          º±±
±±º          ³                                                            º±±
...
User Function STCTBR02()

Local oReport        

PutSx1("STCTBR02", "01","Data de?"  ,"","","mv_ch1","D",8,0,0,"G","",		,"","","mv_par01","","","","","","","","","","","","","","","","")
PutSx1("STCTBR02", "02","Data ate?" ,"","","mv_ch2","D",8,0,0,"G","",		,"","","mv_par02","","","","","","","","","","","","","","","","")                   
...
oReport := TReport():New("STCTBR02","RELATÓRIO DE PRODUTOS POR NOTA","STCTBR02",{|oReport| ReportPrint(oReport)},"Este programa irá imprimir um relatório de produtos por nota fiscal.")
...
oSection:Cell("CFOP")  	  	 :SetBlock( { || aDados[6] } )
oSection:Cell("CLIENTE")  	 :SetBlock( { || aDados[7] } )
oSection:Cell("DOC")  		 :SetBlock( { || aDados[8] } )
//oSection:Cell("TP")  		 :SetBlock( { || aDados[14] } )
oSection:Cell("DTEMIS")  	 :SetBlock( { || aDados[9] } )
oSection:Cell("EST")  		 :SetBlock( { || aDados[10] } )
...
cQuery += " D2_ALQIMP6, D2_TOTAL-D2_VALIPI-D2_VALICM-D2_VALIMP5-D2_VALIMP6 TOTGERAL, D2_ICMSRET "
...
While !(cAlias)->(Eof())
	...
	aDados[6]	:=	(cAlias)->D2_CF
	aDados[7]	:=	(cAlias)->D2_CLIENTE
	aDados[8]	:=	(cAlias)->D2_DOC
	//aDados[14]	:=	(cAlias)->D2_TP
	aDados[9]	:=	STOD((cAlias)->D2_EMISSAO)
	aDados[10]	:=	(cAlias)->D2_EST
