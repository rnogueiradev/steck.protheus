...
Static Function PROCESSA()
	...
	For _nY:=1 To Len(aDados)
		...
		_cCod := PADR(AllTrim(aDados[_nY][2]),15)

		aRotAuto:= {{'B1_FILIAL' 		,xFilial("SB1")					,Nil},;
			{'B1_COD' 		,_cCod					,Nil},;
			{'B1_TIPO'   				,aDados[_nY][3]  	,Nil},;
			{'B1_CODITE'   				,aDados[_nY][4]  	,Nil},;
			{'B1_UM'   				,aDados[_nY][5]  	,Nil},;
			{'B1_LOCPAD'   				,aDados[_nY][6]  	,Nil},;
			{'B1_GRUPO'   				,aDados[_nY][7]  	,Nil},;
			{'B1_TE'   				,aDados[_nY][8]  	,Nil},;
			{'B1_SEGUM'   				,aDados[_nY][9]  	,Nil},;
			{'B1_CUSTD'   				,Val(StrTran(StrTran(aDados[_nY][10],".",""),",","."))  	,Nil},;
			{'B1_MCUSTD'   				,aDados[_nY][11]  	,Nil},;
			{'B1_CONTA'   				,aDados[_nY][12]  	,Nil},;
			{'B1_PROC'   				,aDados[_nY][13]  	,Nil},;
			{'B1_XPAIS'   				,aDados[_nY][14]  	,Nil},;
			{'B1_POSIPI'   				,aDados[_nY][15]  	,Nil},;
			{'B1_XNCMARG'   				,aDados[_nY][16]  	,Nil},;
			{'B1_DESC'   				,aDados[_nY][17]  	,Nil},;
			{'B1_XCDRUB'   				,aDados[_nY][18]  	,Nil},;
			{'B1_XDERUB'   				,aDados[_nY][19]  	,Nil},;
			{'B1_XCDSRUB'   				,aDados[_nY][20]  	,Nil},;
			{'B1_XDSRUB'   				,aDados[_nY][21]  	,Nil},;
			{'B1_RASTRO'   				,aDados[_nY][22]  	,Nil},;
			{'B1_LOCALIZ'   				,aDados[_nY][23]  	,Nil};
			}
