...
User Function ARFIN020()
	...
	//Códigos de clientes Steck da Argentina:
	_aEmpStk := StrTokArr(GetMv("STDSOCLIST",,"191259#191260#001073#001074#001082#001104#191272"),"#")	                                         
	...
	MemoWrite("C:\TEMP\ARG_ITEMS.TXT" , _cQuery1)
	...
	_cArqItems  := "items_" + Dtos(Date()) + ".txt"                // Removido arg_ por estar apresentando problemas 04/01/2023 - Valdemir Rabelo
	...
	_cCopia := "" 
	_cAssunto := "MYDSO - ARGENTINA"
	cMsg      := "MYDSO - ARGENTINA"
	cAnexo    := _cFile
	...
	*/
	...
	MemoWrite("C:\TEMP\ARG_CLIENTS.TXT" , _cQuery1)
	...
	_cArqClient := "clients_" + Dtos(Date()) + ".txt"        // Removido arg_ por estar apresentando problemas - Valdemir Rabelo 04/01/2023
