...
Static Function ReportPrint(oReport)
	...
	If Len(aEmpresa) > 0
		...
		cQuery += " LEFT JOIN ( SELECT '01' EMP,B1_COD,D_E_L_E_T_,B1_GRUPO FROM UDBP12.SB1010 WHERE D_E_L_E_T_ = ' ' UNION SELECT '03' EMP, B1_COD,D_E_L_E_T_,B1_GRUPO FROM UDBP12.SB1030 WHERE D_E_L_E_T_ = ' ' UNION SELECT '07' EMP, B1_COD,D_E_L_E_T_,B1_GRUPO FROM SB1070 WHERE D_E_L_E_T_ = ' ' UNION SELECT '08' EMP, B1_COD,D_E_L_E_T_,B1_GRUPO FROM UDBP12.SB1080 WHERE D_E_L_E_T_ = ' ' ) B1 ON B1_COD = NF.COD AND B1.EMP = NF.EMP AND B1.D_E_L_E_T_ = ' '

		cQuery += " LEFT JOIN (SELECT '01' EMP, BM_XAGRUP,BM_GRUPO,D_E_L_E_T_ FROM UDBP12.SBM010 WHERE D_E_L_E_T_ = ' ' UNION SELECT '03' EMP,BM_XAGRUP,BM_GRUPO,D_E_L_E_T_ FROM UDBP12.SBM030 WHERE D_E_L_E_T_ = ' ' UNION SELECT '07' EMP,BM_XAGRUP,BM_GRUPO,D_E_L_E_T_ FROM SBM070 WHERE D_E_L_E_T_ = ' ' UNION SELECT '08' EMP,BM_XAGRUP,BM_GRUPO,D_E_L_E_T_ FROM UDBP12.SBM080 WHERE D_E_L_E_T_ = ' '  ) BM ON B1.B1_GRUPO = BM.BM_GRUPO AND BM.EMP = B1.EMP AND BM.D_E_L_E_T_ = ' '
