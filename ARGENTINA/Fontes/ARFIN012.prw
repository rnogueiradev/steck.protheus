...
±±ºPrograma  ³ ARFIN012  º Autor ³ Cristiano Pereiraº Data ³  30/03/13    º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Listado los cobros vendedores                               º±±
±±º          ³                                                            º±±
...
Static Function ReportDef()
	...
	oReport := TReport():New("ARFIN012","Listado los cobros vendedores","ARFIN012",{|oReport| ReportPrint(oReport)},"Listado los Cobros vendedores.")
	...
	oSection1 := TRSection():New(oReport,"Cobros vendedores",{"SE1"},)
	...
	TRCell():New(oSection1,"DIAS"		    ,,"DIAS DE RETRASO "	,"@!",16,.F.,)
...
Static Function ReportPrint(oReport)
	...
	Local cTitulo		:= OemToAnsi("Listado del cobros vendedores")
	...
	oSection1:Cell("VEND"  )		:SetBlock( { || aDados1[1] })
	oSection1:Cell("NOMVEN" )		:SetBlock( { || aDados1[2] })
	oSection1:Cell("TITULO" )		:SetBlock( { || aDados1[3] })
	...
	oSection1:Cell("DIAS" )	:SetBlock( { || aDados1[9] })
	oSection1:Cell("HISTOR" )	:SetBlock( { || aDados1[10] })
	oSection1:Cell("CLIENTE" )	:SetBlock( { || aDados1[11] })
	oSection1:Cell("NOMCLI" )	:SetBlock( { || aDados1[12] })
	...
	cQuery1 += "       SE1.E1_VEND1 >='"+MV_PAR01+"'                                           AND                            "
	cQuery1 += "       SE1.E1_VEND1 <='"+MV_PAR02+"'                                           AND                            "
	...
	While (cAlias1)->(!Eof())
		...
		aDados1[01]  := (cAlias1)->(VEND)   
		aDados1[02]  := (cAlias1)->(NOVND)
		aDados1[03]  := (cAlias1)->(NUM)
		...
		aDados1[09]  :=  StrZero(MSDATE()- Stod((cAlias1)->(VENCTO)),6)
		aDados1[10]  := (cAlias1)->(HISTOR)
		aDados1[11]  := (cAlias1)->(CLIENTE)   
		aDados1[12]  := (cAlias1)->NOMCLI
