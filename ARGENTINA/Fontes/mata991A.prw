...
If  lEmitidas .Or. lVendas
	...
	DbCreateInd(cArqTmp,"EMISSAO+COMPROV+F3_NFISCAL")
	nCposVen := FCount()
Endif
//Arquivo temporario para os registros de COMPRAS
If lCompras
	cArqCom := CriaTrab(aStru)
	cAliasCom := GetNextAlias()
	DbUseArea(.T.,,cArqCom,cAliasCom,.F.,.F.)
	DbSelectArea(cAliasCom)
	DbCreateInd(cArqCom,"EMISSAO+COMPROV+F3_NFISCAL")
	nCposCom := FCount()
Endif
DbSelectArea("SF3")
...
If lCompras
	DbSelectArea(cAliasCom)
	DbCloseArea()
	FErase(cArqCom+GetDBExtension())
	FErase(cArqCom+IndexExt())	
Endif
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function M991TpComp(cAlias,cSerie,cEspecie)                                           
...
If Empty(cCodTipo)
	Do Case
		Case Substr(cSerie,1,1) == "A" .And. "NCP"$cEspecie 
			cCodTipo := "090"
		Case Substr(cSerie,1,1) == "A" .And. "NF"$cEspecie 
			cCodTipo := "01"
		Case Substr(cSerie,1,1) == "A" .And. "ND"$cEspecie
			cCodTipo := "02"
		Case Substr(cSerie,1,1) == "A" .And. "NC"$cEspecie
			cCodTipo := "03"
		Case Substr(cSerie,1,1) == "B" .And. "NF"$cEspecie
			cCodTipo := "06"
		Case Substr(cSerie,1,1) == "B" .And. "ND"$cEspecie
			cCodTipo := "07"
		Case Substr(cSerie,1,1) == "B" .And. "NC"$cEspecie
			cCodTipo := "08"
		Case Substr(cSerie,1,1) == "C" .And. "NF"$cEspecie
			cCodTipo := "11"
		Case Substr(cSerie,1,1) == "C" .And. "ND"$cEspecie
			cCodTipo := "12"
		Case Substr(cSerie,1,1) == "C" .And. "NC"$cEspecie
			cCodTipo := "13"
		Case Substr(cSerie,1,1) == "E" .And. "NF"$cEspecie
			cCodTipo := "19"
		Case Substr(cSerie,1,1) == "E" .And. "ND"$cEspecie
			cCodTipo := "20"
		Case Substr(cSerie,1,1) == "E" .And. "NC"$cEspecie
			cCodTipo := "21"
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function M991NrComp(cDoc,cTpComp)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function MT991SETpC(cAlias,cCodTipo)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function PesqInfImp(cAlias,nCatImp,cInf,cTES,cTpRet)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function IndExGrv(nAliq,nTotIsen,nTotNAlc,cAlias,lNAlcIVA)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function PesqIdCliFor(cAlias,cOpc,nValBrut,cIDAnt,lNum)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function TotCat(nCatImp,cInf,aImps,cTpRet,nValMerc,aAliq,nAliq,lTot,lConvert)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/                                                                
Static Function fImpsMta991(cCat)
