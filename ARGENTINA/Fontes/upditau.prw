...
/*/
//--------------------------------------------------------------------
User Function UPDITAU( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDITAU" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDITAU" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Forma Pago'															, ; //X3_TITULO
	'Forma Pago'															, ; //X3_TITSPA
	'Forma Pago'															, ; //X3_TITENG
	'Forma Pago asoc. Prov.'												, ; //X3_DESCRIC
	'Forma Pago asoc. Prov.'												, ; //X3_DESCSPA
	'Forma Pago asoc. Prov.'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'0=Normal;1=Itau Cheque;2=Itau con CBU;3=Itau sin CBU'					, ; //X3_CBOX
	'0=Normal;1=Itau Cheque;2=Itau con CBU;3=Itau sin CBU'					, ; //X3_CBOXSPA
	'0=Normal;1=Itau Cheque;2=Itau con CBU;3=Itau sin CBU'					, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Suc. Pago'																, ; //X3_TITSPA
	'Suc. Pago'																, ; //X3_TITENG
	'Sucursal Pago'															, ; //X3_DESCRIC
	'Sucursal Pago'															, ; //X3_DESCSPA
	'Sucursal Pago'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tip. Distrib'															, ; //X3_TITULO
	'Tip. Distrib'															, ; //X3_TITSPA
	'Tip. Distrib'															, ; //X3_TITENG
	'Tipo de Distribucion'													, ; //X3_DESCRIC
	'Tipo de Distribucion'													, ; //X3_DESCSPA
	'Tipo de Distribucion'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'01=Sucursal Itau'														, ; //X3_CBOX
	'01=Sucursal Itau'														, ; //X3_CBOXSPA
	'01=Sucursal Itau'														, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'CTA BCO'																, ; //X3_TITSPA
	'CTA BCO'																, ; //X3_TITENG
	'Cuenta Bancaria'														, ; //X3_DESCRIC
	'Cuenta Bancaria'														, ; //X3_DESCSPA
	'Cuenta Bancaria'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Lote Itau'																, ; //X3_TITSPA
	'Lote Itau'																, ; //X3_TITENG
	'Lote Itau'																, ; //X3_DESCRIC
	'Lote Itau'																, ; //X3_DESCSPA
	'Lote Itau'																, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'ID Arch.Itau'															, ; //X3_TITULO
	'ID Arch.Itau'															, ; //X3_TITSPA
	'ID Arch.Itau'															, ; //X3_TITENG
	'ID Archivo Itau'														, ; //X3_DESCRIC
	'ID Archivo Itau'														, ; //X3_DESCSPA
	'ID Archivo Itau'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX6, { ;
	...
	'IT_XNUMCNV'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Numero de convenio'													, ; //X6_DESCRIC
	'Numero de convenio'													, ; //X6_DSCSPA
	'Numero de convenio'													, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'IT_XPRODCV'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Numero de producto al cual está vinculado el'							, ; //X6_DESCRIC
	'Numero de producto al cual está vinculado el'							, ; //X6_DSCSPA
	'Numero de producto al cual está vinculado el'							, ; //X6_DSCENG
	'convenio'																, ; //X6_DESC1
	'convenio'																, ; //X6_DSCSPA1
	'convenio'																, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSXA, { ;
	'SA2'																	, ; //XA_ALIAS
	'9'																		, ; //XA_ORDEM
	'Interfaz ITAU'															, ; //XA_DESCRIC
	'Interfaz ITAU'															, ; //XA_DESCSPA
	'Interfaz ITAU'															, ; //XA_DESCENG
	''																		, ; //XA_AGRUP
	''																		, ; //XA_TIPO
	'U'																		} ) //XA_PROPRI
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDITAU" ) ) ) ;
